...
export default function VideoGenerator({ status: _status }: VideoGeneratorProps) {
        ...
        <div className="flex items-center gap-2">
          {images.length > 0 && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-red-400 hover:text-red-300 hover:bg-white/5 transition"
            >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-[#FFD86A] hover:text-[#ffe88a] hover:bg-white/5 transition"
          >
